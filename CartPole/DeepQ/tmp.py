...
class Agent:
        ...
        for episode in range(num_episodes):
            ...
            while True:
                ...
                if done:
                    ...
                    if mean_reward > 490:
                        self.model.save_model("C:/Users/Jan/Dropbox/_Programmieren/Udemy AI Kurs/Data/dqn_cartpole.h5")
                        return
                    self.target_model.update_model(self.model)
    ...
    def play(self, num_episodes, render=True):
        self.model.load_model("C:/Users/Jan/Dropbox/_Programmieren/Udemy AI Kurs/Data/dqn_cartpole.h5")
        for episode in range(num_episodes):
            state = self.env.reset()
            state = np.reshape(state, (1, state.shape[0]))
            while True:
